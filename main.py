...
class TwoPropScreen(BoxLayout):
    ...
    def load_first_ref_in_two(self , num):
        ...
        if num == 0:
            ...
            if tempValue != "":
                text = str(num)
                self.in_ref.label_text = f"Soil Ref ({text})"
...
class MainApp(App):
    ...
    def scan_click(self, instance):
        ...
        if lang == "pe":
            fn = "fonts/Vazirmatn-ExtraBold.ttf"
            t_2p = get_rtl_text("دو پراپ")
            t_4p = get_rtl_text("چهار پراپ")
            t_close = get_rtl_text("بستن")
    ...
    ###################################
        ...
        splash_file = "cornix winner pro.jpg"
        for name in [
            "cornix winner pro.jpg", "cornix winner pro.png", "cornix winner pro.jpeg",
            "image/cornix winner pro.jpg", "image/cornix winner pro.png", "image/cornix winner pro.jpeg",
            "cornix winner pro"
        ]:
